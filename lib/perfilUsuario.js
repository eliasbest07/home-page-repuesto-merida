...
export function construirPerfil({ telefono, rifas, oficial }) {
  ...
  const cedula = String(rifas?.cedula || oficial?.cedula || '').trim()
  ...
  const perfil = {
    ...
    comercio_foto_url: rifas?.comercio_foto_url ?? oficial?.comercio_foto_url ?? '',
    comercio_direccion: rifas?.comercio_direccion ?? oficial?.comercio_direccion ?? '',
    comercio_lat: rifas?.comercio_lat ?? oficial?.comercio_lat ?? null,
    comercio_lng: rifas?.comercio_lng ?? oficial?.comercio_lng ?? null,
    vender: rifas?.vender ?? oficial?.vender ?? false,
