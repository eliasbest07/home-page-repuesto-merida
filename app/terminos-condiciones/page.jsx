...
export default function TerminosCondiciones() {
  return (
    <LegalPage title="Términos y Condiciones de Uso" updated={LEGAL_UPDATED_LABEL}>
      <section>
        <h2>1. Aceptación</h2>
        <p className="mt-2">
      ...
      <section>
        <h2>11. Publicidad, promociones y servicios externos</h2>
        <p className="mt-2">
      ...
      <section>
        <h2>12. Disponibilidad y cambios</h2>
        <p className="mt-2">
      ...
      <section>
        <h2>14. Suspensión o terminación</h2>
        <p className="mt-2">
      ...
      <section>
        <h2>15. Legislación y resolución de disputas</h2>
        <p className="mt-2">
